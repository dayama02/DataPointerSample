...
class CDataProviderCtrl : public ITcOCFCtrlImpl<CDataProviderCtrl, CDataProviderClassFactory>
{
public:
	CDataProviderCtrl() {};
...
{
	HRESULT hr = E_FAIL;
	TRACE("DataProvider: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CDataProviderCtrl>;

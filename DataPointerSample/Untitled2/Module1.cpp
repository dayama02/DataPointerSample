...
IMPLEMENT_IPERSIST_LIB(CModule1, VID_Untitled2, CID_Untitled2CModule1)
...
///<AutoGeneratedContent id="SetObjectParameterMap">
	...
	SETOBJPARA_DATAPTR(PID_Module1DataPointer1, m_spDataPointer1)
///</AutoGeneratedContent>
END_SETOBJPARA_MAP()
...
HRESULT CModule1::CycleUpdate(ITcTask* ipTask, ITcUnknown* ipCaller, ULONG_PTR context)
{
	...
	if (m_spDataPointer1 != NULL) {
		//m_Outputs.Data = *m_spDataPointer1;
		memcpy(&m_Outputs.Data, m_spDataPointer1, sizeof(ULONG));
	}
	return hr;
}
///</AutoGeneratedContent>
...
///////////////////////////////////////////////////////////////////////////////
HRESULT CModule1::InitDataPointer()
{
	m_Trace.Log(tlVerbose, FENTERA);

	HRESULT hr = S_OK;
	hr = FAILED(hr) ? hr : m_spDataPointer1.Init(m_spSrv);
...
///////////////////////////////////////////////////////////////////////////////
VOID CModule1::DeinitDataPointer()
{
	m_Trace.Log(tlVerbose, FENTERA);

	m_spDataPointer1 = NULL;
	m_Trace.Log(tlVerbose, FLEAVEA);
}
